...
import { Loader2, Camera, User, Lock, CheckCircle2 } from 'lucide-react';
    ...
    reader.onload = (event) => {
      ...
      img.onload = async () => {
        ...
        try {
          ...
          setProfileData((prev: any) => ({ ...prev, photoBase64: dataUrl }));
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 mb-8">
        <div className="flex flex-col md:flex-row items-center gap-8 mb-8 pb-8 border-b border-gray-100">
          <div className="relative group">
            {profileData.photoBase64 ? (
              <img src={profileData.photoBase64} alt="ID Card" className="w-32 h-32 rounded-full object-cover shadow-md border-4 border-white" />
            ) : (
        ...
        <div>
          ...
          <form onSubmit={handleChangePassword} className="max-w-sm">
            ...
            />
            <button type="submit" className="px-6 py-2 bg-gray-900 text-white rounded-xl font-semibold hover:bg-gray-800 transition-colors">
              Update Password
            </button>
